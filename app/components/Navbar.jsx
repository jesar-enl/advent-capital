...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-l from-green-800 via-teal-700 to-teal-500 fixed w-full z-20 top-0 start-0 border-b border-gray-400 h-26 mb-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          ...
          <div className="space-y-1 px-2 pb-3 pt-2">
            <ul className="flex flex-col md:p-0 mt-4 font-medium rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
              <li>
                <a
                  href="/about"
                  className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
